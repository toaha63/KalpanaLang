...
```KalpanaLang
        ...
        বাক্যের_অ্যারে linkedConstants[] ⮕
        {
            ...
            "ন্ট", "ন্ট্র", "ন্ঠ", "ন্ড", "ন্ড্র", "ন্ত", "ন্ত্ব", "ন ্ত্য", "ন্ত্র", "ন্ত্র্য", "ন্থ", "ন্থ্র", "ন্দ", "ন্দ্য", "ন্দ্ব",
...
৪) পর্যাপ্ত লাইব্রেরী এখনো আমরা তৈরি করতে পারিনি।

৫) কিছু লুকায়িত বাগ থাকতে পারে যা সম্পর্কে আমরা জানিনা।

৬) গভীর রিকার্শনে StackOverflow সমস্যা। (Heap Memory বাড়িয়ে নিলে কিছুটা রেহাই পাওয়া যায়)

৭) খুব বড় ভ্যারিয়বলের ক্ষেত্রে পারফরম্যান্স ড্রপ।

৮) পর্যাপ্ত অপটিমাইজেশন নেই।

৯) পাইথন থেকেও ধীরগতির।

১০) জাভাতে লেখায় JRE ছাড়া চালানো যায়না।

১১) বিল্টইন JIT ফিচার নেই, জাভার উপর নির্ভরশীল।

১২) JVM Startup এর জন্য প্রথম প্রথম ধীরে কাজ করে, তবে JVM Warmup হয়ে গেলে অনেক দ্রুত কাজ করে।

১৩) অ্যারেতে সম্ভবত **2147483648** টি এলিমেন্টের পরে আর এলিমেন্ট রাখা  যাবেনা (পরীক্ষা করা হয়নি।)

১৪) অ্যারে সর্টিং ছোটো থেকে বড় ক্রমে করার বিল্ট-ইন ফাংশন আছে, তবে বড় থেকে ছোটো ক্রমে করার ফাংশন নেই। পরের কোনো সংস্করণে ঠিক করা হবে।
...
৬) অফিসিয়াল উইন্ডোজ সংস্করণ , সঙ্গে মিনিমাল JRE।

৭) অনলাইন ইন্টারপ্রেটার।

৮) লোগো ও মাসকট।

৯) RELP টুল।

১০) কমান্ড-লাইন আর্গুমেন্ট।
